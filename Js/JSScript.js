...
(function ($, Sys) {
    ...
    $(document).ready(function () {
        ...
        $('.JSLicense .link-5-star.no-txt')
            .html(function () {
                var $stars = '';
                for (var i = 0; i < 5; i++) $stars += $lnkStar;
                return $stars;
            });
        $('.JSLicense .link-4-star.no-txt')
            .html(function () {
                var $stars = '';
                for (var i = 0; i < 4; i++) $stars += $lnkStar;
                return $stars;
            });
        $('.JSLicense .link-3-star.no-txt')
            .html(function () {
                var $stars = '';
                for (var i = 0; i < 3; i++) $stars += $lnkStar;
                return $stars;
            });
        $('.JSLicense .link-2-star.no-txt')
            .html(function () {
                var $stars = '';
                for (var i = 0; i < 2; i++) $stars += $lnkStar;
                return $stars;
            });
        $('.JSLicense .link-1-star.no-txt')
            .html(function () {
                var $stars = '';
                for (var i = 0; i < 1; i++) $stars += $lnkStar;
                return $stars;
        ...
        $('.JSLicense [data-toggle="popover"]').popover({
            trigger: 'focus', //'click', 'hover', 'focus', 'click hover'
        });
        ...
        $('.JSLicense .hidder input:checkbox')
            .each(function () {
                var $this = $(this),
        ...
        $('.JSLicense .unhidder input:checkbox')
            .each(function () {
                var $this = $(this),
                    $target = $this.parent().data('target');
        ...
        $('.JSLicense .check-equal-two-options')
            .each(function () {
                if ($(this).val() === $(this).data('equal') || $(this).val() === $(this).data('equal-two')) $($(this).data('target')).show();
                else $($(this).data('target')).hide();
            })
            .bind('change', function () {
                if ($(this).val() === $(this).data('equal') || $(this).val() === $(this).data('equal-two')) $($(this).data('target')).show();
        ...
        $('.JSLicense .uncheck-equal-two-options')
            .each(function () {
                if ($(this).val() !== $(this).data('equal') || $(this).val() !== $(this).data('equal-two')) $($(this).data('target')).show();
                else $($(this).data('target')).hide();
            })
        ...
        $('.JSLicense .hidder-radio-equal input:radio')
            .each(function () {
                if ($(this).is(':checked')) {
                    if ($(this).val() === $(this).closest('.hidder-radio-equal').data('equal')) $($(this).closest('.hidder-radio-equal').data('target')).show();
                    else $($(this).closest('.hidder-radio-equal').data('target')).hide();
                }
            })
            .bind('change', function () {
                if ($(this).is(':checked')) {
        ...
        $('.JSLicense .hidder-radio-option input:radio')
            .each(function () {
